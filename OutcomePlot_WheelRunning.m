...
function OutcomePlot_WheelRunning(AxesHandle, Action, varargin)
%% 
...
switch Action
    case 'init'
        ...
        set(AxesHandle,'TickDir', 'out','YLim', [-3, 2], 'YTick', [0 1],'YTickLabel', {'Go B','Go A'}, 'FontSize', 16);
    ...
    case 'update'
        ...
        if ~isempty(OutcomeRecord)
            ...
            scatter(AxesHandle,  indxToPlot(EarlyWithdrawalTrialsIndx), SideList(indxToPlot(EarlyWithdrawalTrialsIndx)),'go','MarkerFaceColor',[1 1 1]);
            %Plot Error, punished
            ...
            scatter(AxesHandle,  indxToPlot(DidNotChooseTrialsIndx), SideList(indxToPlot(DidNotChooseTrialsIndx)),'ro','MarkerFaceColor',[1 1 1]);
            %Plot DidNotChoose
