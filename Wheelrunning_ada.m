...
if S.TrialSequence(currentTrial)==1  
    ...
    sma = AddState(sma, 'Name', 'WaitForRun', ...
        'Timer',5,...
        'StateChangeConditions', {'Tup','DeliverPunish','BNC2High','SpeedCheck_1'},...
        'OutputActions',{});  
    sma = AddState(sma, 'Name', 'SpeedCheck_1', ...
        'Timer',1,...
        'StateChangeConditions', {'Tup','DeliverPunish','BNC2High','SpeedCheck_2'},...
        'OutputActions',{});  
    sma = AddState(sma, 'Name', 'SpeedCheck_2', ...
        'Timer',1,...
        'StateChangeConditions', {'Tup','DeliverPunish','BNC2High','AvoidSucc'},...
        'OutputActions',{});  
end   
