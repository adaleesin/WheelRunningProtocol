...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.GUI.MeanSoundFrequency_1 = 2000;  %Hz
    S.GUI.MeanSoundFrequency_2 = 4000;  %Hz
    S.GUI.MeanSoundFrequency_3 = 6000;  %Hz
    S.GUI.MeanSoundFrequency_4 = 8000;  %Hz
    S.GUI.MeanSoundFrequency_5 = 10000;  %Hz
...
Sound_run1= GenerateSineWave(SF, S.GUI.MeanSoundFrequency_1, 10); % Sampling freq (hz), Sine frequency (hz), duration (s)
Sound_run2= GenerateSineWave(SF, S.GUI.MeanSoundFrequency_2, 10); 
Sound_run3= GenerateSineWave(SF, S.GUI.MeanSoundFrequency_3, 10); 
Sound_run4= GenerateSineWave(SF, S.GUI.MeanSoundFrequency_4, 10); 
Sound_run5= GenerateSineWave(SF, S.GUI.MeanSoundFrequency_5, 0.2); 
...
PsychToolboxSoundServer('Load', 3, Sound_run1); %PsychToolboxSoundServer('load', SoundID, Waveform)
PsychToolboxSoundServer('Load', 4, Sound_run2);
PsychToolboxSoundServer('Load', 5, Sound_run3); %PsychToolboxSoundServer('load', SoundID, Waveform)
PsychToolboxSoundServer('Load', 6, Sound_run4);
PsychToolboxSoundServer('Load', 7, Sound_run5); %PsychToolboxSoundServer('load', SoundID, Waveform)
...
%     S.ReinforcementDelays(currentTrial) = random('Normal',1,1);
    ...
    sma = NewStateMatrix();
    sma = SetGlobalCounter(sma, 1, 'BNC1High', 10);
    sma = SetGlobalCounter(sma, 2, 'BNC1High', 20);
    sma = SetGlobalCounter(sma, 3, 'BNC1High', 30);
    sma = SetGlobalCounter(sma, 4, 'BNC1High', 40);
    sma = SetGlobalCounter(sma, 5, 'BNC1High', 50);
...
%         'OutputActions', {'PWM3', 255});  %led light up, send ttl to ni analog acquisition 
   if S.TrialTypes(currentTrial)==1
    sma = AddState(sma, 'Name', 'WaitForRun', ...
            'Timer',10,...
            'StateChangeConditions', {'Tup', 'Timeout', 'GlobalCounter1_End', 'Tone_feedback1','GlobalCounter2_End', 'Tone_feedback2','GlobalCounter3_End', 'Tone_feedback3','GlobalCounter4_End', 'Tone_feedback4','GlobalCounter5_End', 'Tone_feedback5'},...
            'OutputActions', {'PWM3', 255});
    sma = AddState(sma, 'Name', 'Tone_feedback1', ...
            'Timer',0,...
            'StateChangeConditions', {'Tup', 'WaitForRun'},...
            'OutputActions',  {'SoftCode', 3});  
    sma = AddState(sma, 'Name', 'Tone_feedback2', ...
            'Timer',0,...
            'StateChangeConditions', {'Tup', 'WaitForRun'},...
            'OutputActions',  {'SoftCode', 4}); 
    sma = AddState(sma, 'Name', 'Tone_feedback3', ...
            'Timer',0,...
            'StateChangeConditions', {'Tup', 'WaitForRun'},...
            'OutputActions',  {'SoftCode', 5}); 
    sma = AddState(sma, 'Name', 'Tone_feedback4', ...
            'Timer',0,...
            'StateChangeConditions', {'Tup', 'WaitForRun'},...
            'OutputActions',  {'SoftCode', 6}); 
    sma = AddState(sma, 'Name', 'Tone_feedback5', ...
            'Timer',0,...
   ...
   elseif S.TrialTypes(currentTrial)==2
           sma = AddState(sma, 'Name', 'WaitForRun', ...
            'Timer',10,...
            'StateChangeConditions', {'Tup', 'DeliverReward', 'GlobalCounter1_End', 'DeliverPunish','GlobalCounter2_End', 'DeliverPunish','GlobalCounter3_End', 'DeliverPunish','GlobalCounter4_End', 'DeliverPunish','GlobalCounter5_End', 'DeliverPunish'},...
            'OutputActions', {'PWM3', 255});
   end
