...
global BpodSystem
PulsePal;
load('D:\Bpod_r0_5-master\Protocols\Wheelrunning_ada\LightPulse_1ms.mat');
...
reward_valve_times = linspace(MinRew,MaxRew,2000);
...
for currentTrial = 1:maxTrials
    ...
    if S.TrialSequence(currentTrial)==1     
         ...
         sma = AddState(sma, 'Name', 'TimeReset', ...
                    'Timer',0,...
                    'StateChangeConditions', {'Tup','SpeedSample'},...
                    'OutputActions', {'GlobalTimerTrig', 1});    
         sma = AddState(sma, 'Name', 'SpeedSample', ...
                    'Timer',0.01,...
                    'StateChangeConditions', {'BNC1High','FeedBack','GlobalTimer1_End','DeliverReward'},...
                    'OutputActions', {});    
         sma = AddState(sma, 'Name', 'FeedBack', ...
                    'Timer',0.01,...
                    'StateChangeConditions', {'Tup','SpeedSample','GlobalTimer1_End','DeliverReward'},...
                    'OutputActions', {'BNCState',1});
             
   elseif S.TrialSequence(currentTrial)==2
           sma = AddState(sma, 'Name', 'WaitForRun', ...
            'Timer',5,...
            'StateChangeConditions', {'Tup', 'DeliverReward', 'BNC1High', 'DeliverPunish'},...
            'OutputActions', {});
   end
    ...
    sma = AddState(sma,'Name', 'DeliverNoise', ...
        'Timer',1, ...
        'StateChangeConditions', {'Tup', 'KeepWaiting','GlobalTimer1_End','exit'},...
        'OutputActions', {'SoftCode', 21});
    sma = AddState(sma,'Name', 'KeepWaiting', ...
        'Timer',1, ...
        'StateChangeConditions', {'BNC2High', 'DeliverNoise','GlobalTimer1_End','exit'},...
        'OutputActions', {});
