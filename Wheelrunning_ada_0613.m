...
%         'OutputActions', {'ValveState', 1});
    ...
    if S.TrialSequence(currentTrial)==1     
         sma = AddState(sma, 'Name', 'WaitForRun', ...
                    'Timer',10,...
                    'StateChangeConditions', {'GlobalTimer1_End','TimeOut','BNC1High','FeedBack','BNC2High','DeliverReward'},...
                    'OutputActions', {});  
         sma = AddState(sma, 'Name', 'FeedBack', ...
                    'Timer',0.01,...
                    'StateChangeConditions', {'GlobalTimer1_End','TimeOut','Tup','SpeedSample','BNC2High','DeliverReward'},...
